...
public class GameplayManager : MonoBehaviour
{
    ...
    void Start()
    {
        mainText.text = "Hey bro welcome to the Sumerian Game. Your goal is to manage the grain supply for your city and grow it to the largest population possible." +
